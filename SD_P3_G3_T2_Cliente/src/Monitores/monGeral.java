...
/**
 *Regiao partilhada Repositorio Geral (Servidor).
 * esta regiao contem os estados de todas as entidades activas.
 * É responsavel pela criaçao e preenchimento do ficheiro de logging
 * @author rofler
 */
   ...
   */
    ...
    */
    ...
    public void pMGasta(int quantPM)
    {
        ...
        if (this.totalPM==0)
            System.out.println("Nao ha mais PM no sistema.");
